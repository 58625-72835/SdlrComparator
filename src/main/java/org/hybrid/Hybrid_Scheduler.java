...
//            long length = (long) (1e3 * (commMatrix[i][dcId] + execMatrix[i][dcId]));
        long length = (long)(randObj.nextDouble()*600+500)*1000;
...
//        mapping = PSOSchedularInstance.run();
        ...
        try {
            ...
            HybridDatacenterBroker broker = createBroker("Broker_0");
...
//            broker.setMapping(mapping);
            ...
            Log.printLine(Hybrid_Scheduler.class.getName() + " finished!");
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private static HybridDatacenterBroker createBroker(String name) throws Exception {
