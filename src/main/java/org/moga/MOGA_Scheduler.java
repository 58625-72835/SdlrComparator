...
//        mapping = PSOSchedularInstance.run();
        ...
        try {
            ...
            MOGADatacenterBroker broker = createBroker("Broker_0");
...
//            broker.setMapping(mapping);
            ...
            Log.printLine(MOGA_Scheduler.class.getName() + " finished!");
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private static MOGADatacenterBroker createBroker(String name) throws Exception {
